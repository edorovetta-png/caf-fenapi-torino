...
%(nav)s%(cta)s        </aside>
        <div class="service-content">
          ...
          <details class="bandi-archivio fade-in" id="bandiArchivio">
            <summary><span>Archivio bandi conclusi (<span id="bandiChiusiCount">0</span>)</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg></summary>
            <div id="bandiChiusi"></div>
          </details>
          <div class="content-cta fade-in" style="margin-top:24px;">
