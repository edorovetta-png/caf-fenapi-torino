...
- Design system v2 "Refined Editorial" lives in `styles.css` with CSS custom properties derived from `fenapi-group-brand-guidelines.md`.
...
### Environment
- `.env` in this directory holds API keys (currently placeholders)
